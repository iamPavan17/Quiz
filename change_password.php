<?php
	...
	// 	$query = " UPDATE `users` SET `password`= '$pass' WHERE `std_id` = $id";
	// 	// echo $query;
	...
	if(isset($_POST['change']))
	{
		...
		$query = " UPDATE `organiser` SET `o_password`='$new_pass' WHERE `o_id`=$o_id";
		mysqli_query($connect, $query);
		header('Location: success_org.php');
	}
			...
			<div class="wrap-login100">
				<form class="login100-form validate-form" method="POST">
					...
					<div class="wrap-input100 validate-input" data-validate = "Enter id">
						<input class="input100" type="text" name="o_id" placeholder="Organiser ID">
